...
register_commands = function()
    vim.api.nvim_create_user_command('TuiToggleTerminals', 'lua require("tui.ui.visibility.terminal").toggle()', {})
    vim.api.nvim_create_user_command('TuiShowTerminals', 'lua require("tui.ui.visibility.terminal").show()', {})
    vim.api.nvim_create_user_command('TuiHideTerminals', 'lua require("tui.ui.visibility.terminal").hide()', {})
